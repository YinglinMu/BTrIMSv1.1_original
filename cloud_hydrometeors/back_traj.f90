...
! Height of parcel release is determined randomly from a humidity-weighted vertical profile, i.e the vertical distribution of cloud water mass indicates where the rain forms.
...
PROGRAM back_traj
	...
	do dd = 1, totdays
		...
		call calc_pw(mixcld(:,:,:,datatotsteps-datadaysteps:),pres(:,:,:,datatotsteps-datadaysteps:),psfc(:,:,datatotsteps-datadaysteps:),ptop,pw)
