...
! Air parcels move kinetically in horizontal, but isentropically, i.e., along the s=iso-surface of potential temperature.
...
PROGRAM back_traj
	...
	do dd = 1, totdays
        ...
        call calc_tpw_pbl(mixtot,pres,psfc,tpw,pbl_lev) !Yinglin: this is the total precipitable water within the boundary layer
