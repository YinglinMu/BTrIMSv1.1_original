...
! bicubic method is used for with grid interpolation when air parcel is not at the center of the grid cell.
...
PROGRAM back_traj
	...
	do dd = 1, totdays
        ...
        !call calc_tpw_pbl(mixtot,pres,psfc,tpw,pbl_lev) !total precipitable water within the boundary layer
