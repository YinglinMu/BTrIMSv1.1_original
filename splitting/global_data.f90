...
! The PBL is split from the upper atmosphere, i.e. ET is well-mixed within PBL, 'ET-mixing' method is used, in the upper troposphere, moisture contribution is represented by change of water mass content in the parcel, WaterSip identification method is used.
